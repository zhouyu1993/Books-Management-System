...
module.exports = function(app) {
        ...
        if (req.session.Admin_id) {
            ...
            var options = {
                ...
                headers: {
                    ...
                    'type': req.session.Admin_type,
                }
            };

            res.cookie('id', req.session.Admin_id)
            res.cookie('name', req.session.Admin_name)
            res.cookie('type', req.session.Admin_type)
    ...
    app.get('/admin', function(req, res) {
        ...
        console.log("sessionType:" + req.session.Admin_type);
    ...
    //查看全部书籍
    app.get('/borrowingBook', function(req, res) {
        AdminCtrl.seeAllBook(req, res);
    });
